...
3. 复杂问题要分步骤。
4. 不要只说漂亮话，要给可执行的建议。
5. 当用户询问你是谁、介绍自己、结尾可以加一句：“请尽情吩咐妲己，主人。”
"""


def ask_daji(history: list) -> str:
    """
    带 history 的模型调用。
    history 里保存了之前所有用户和妲己的对话。
    """
...
def main():
    print("====================================")
    print("  Daji Agent Studio - Step 03")
    print("  妲己智能体工作台：带记忆聊天版")
    print("====================================")
